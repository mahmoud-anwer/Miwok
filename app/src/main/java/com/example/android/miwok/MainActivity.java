    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewNumbers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is for start new activity
                Intent i = new Intent(getBaseContext(), NumbersActivity.class);
                startActivity(i);
                //Toast.makeText(v.getContext(),"Numbers view is clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        textViewColors.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is for start new activity
                Intent i = new Intent(getBaseContext(), ColorsActivity.class);
                startActivity(i);
            }
        });
        ...
        textViewFamily.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is for start new activity
                Intent i = new Intent(getBaseContext(), FamilyActivity.class);
                startActivity(i);
            }
        });
        ...
        textViewPhrases.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is for start new activity
                Intent i = new Intent(getBaseContext(), PhrasesActivity.class);
                startActivity(i);
            }
        });
